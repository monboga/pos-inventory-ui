...
// Acepta la lista de 'cartItems' como prop.
function OrderSummary({ cartItems }) {
    ...
    useEffect(() => {
        // Se calcula el subtotal sumando el precio de todos los productos en el carrito.
        const newSubtotal = cartItems.reduce((sum, item) => sum + item.price, 0);
        // Se calcula el impuesto basado en el nuevo subtotal.
    ...
    return (
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 h-full flex flex-col">
            ...
            {/* Se añade 'border-pink-100' para cambiar el color del borde. */}
            ...
            <div className="flex-grow my-4 overflow-y-auto">
                ...
                {cartItems.length === 0 ? (
                    ...
                    cartItems.map((item, index) => (
                        <div key={`${item.id}-${index}`} className="flex justify-between items-center mb-3">
